...
if __name__ == "__main__":
    ...
    for topicname in topicnameSet:
        print topicname
        # # 输入
        # inputFile = "../all_asc_tweetsOutput/SpecialDomain/"+topicname+"/Feature/FeatureMatrixWithNPWRelation"
        # # 输出
        # outputFile = "../all_asc_tweetsOutput/SpecialDomain/"+topicname+"/sparkDataSet/testFile"
