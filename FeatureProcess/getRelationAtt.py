...
if __name__ == "__main__":
    ...
    for topicname in topicnameSet:
        ...
        sentimentfilename = "../all_asc_tweetsOutput/SpecialDomain/"+topicname+"/Divided/sentiment"
        tweetrelationfilename = "../all_asc_tweetsOutput/SpecialDomain/"+topicname+"/Preprocess/tweetrelation"
        # 输出：
        relationattributefilename = "../all_asc_tweetsOutput/SpecialDomain/"+topicname+"/Feature/RelationAtt"
        DicTweetNoSentiment={}
