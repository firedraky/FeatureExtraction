...
if __name__ == "__main__":
    ...
    for topicname in topicnameSet:
        print topicname
        # 输入：
        authornamefilename = "../all_asc_tweetsOutput/SpecialDomain/"+topicname+"/Divided/author.name"
        contentfilename = "../all_asc_tweetsOutput/SpecialDomain/"+topicname+"/Divided/content"
        # 输出：
